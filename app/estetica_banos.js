...
export default function EsteticaBanosScreen() {
        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContentContainer}>
                <View style={[styles.headerRow, { justifyContent: 'space-between' }]}>
                    ...
                    <Text style={styles.sectionTitle}>Estética y Baños</Text>
                </View>
                ...
                <TouchableOpacity style={styles.saveButton} onPress={() => { }}>
                    <Text style={styles.saveButtonText}>+ Agregar Estética/Baños</Text>
                </TouchableOpacity>

                <View style={[styles.section, { minHeight: 200, marginTop: Spacing.m }]} />
            </ScrollView>

            <PatientSidebarMenu isOpen={showPatientMenu} onClose={() => setShowPatientMenu(false)} paciente={pacienteParam} apiHost={apiHost} selectedItem={'estetica_banos'} />
        </View>
    );
