...
const MedicamentosLista = forwardRef(({ isEditable = true, initial = [], onChange }, ref) => {
    ...
    // Refs para los ApiAutocomplete por item, y estado para enfocar el último agregado
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <View style={styles.titleRow}>
                    <Image source={require('../assets/images/medicamento.png')} style={styles.icon} resizeMode="contain" />
...
MedicamentosLista.displayName = 'MedicamentosLista';
